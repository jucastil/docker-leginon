...
define('PROJECT_TITLE',"DOCKER Appion and Leginon DB Tools");
...
define('BASE_URL',"/myamiweb/");
define('PROJECT_URL',"/myamiweb/project/");
...
define('ENABLE_ANONYMOUS', true);
define('COOKIE_PASSPHRASE',"biolbiol");

// --- Administrator email title and email address -- //
define('EMAIL_TITLE',"SB Leginon Admin");
...
define('DB_HOST',"sbleginon");
define('DB_USER',"usr_object");
define('DB_PASS',"BIOLBIOL");
